...
const Terms = () => {
  ...
  return (
    <div className="min-h-screen bg-navy-dark">
      <SEO title={`${t("terms.title")} — Impera`} description={t("terms.title")} path="/terms" />
      <Navbar />
      ...
      <section className="pt-32 pb-20 px-6">
        <div className="container mx-auto max-w-3xl">
          ...
          {/* Terms content stays in English as legal documents typically do */}
          <div className="space-y-10 font-body text-sm text-cream/80 leading-relaxed">
            <div>
              ...
              <p>Impera provides digital marketing and consulting services including, but not limited to: brand strategy, digital marketing campaigns, search engine optimization (SEO), web development, content creation, and performance marketing, as described on our website and in individual service agreements.</p>
              <p className="mt-3">Specific deliverables, timelines, and scope of work are defined in individual project proposals or service agreements between Impera and the client.</p>
            </div>
            <div>
            ...
            <div>
              ...
              <p>The client agrees to provide timely access to all materials, approvals, and information necessary for the completion of agreed services. Delays caused by the client may result in adjusted timelines and, where applicable, additional charges.</p>
            </div>
            <div>
              <h2 className="font-display text-xl font-bold text-cream mb-4">5. Confidentiality</h2>
              <p>Both parties agree to treat all proprietary information, business strategies, and project details as confidential. This obligation survives the termination of any service agreement for a period of two (2) years.</p>
            </div>
            <div>
            ...
            <div>
              ...
              <p>Either party may terminate a service agreement with 30 days' written notice. The client remains responsible for payment of all services rendered up to the termination date, including any work in progress. Upon termination, Impera will deliver all completed work to the client.</p>
            </div>
            <div>
              <h2 className="font-display text-xl font-bold text-cream mb-4">8. Force Majeure</h2>
              <p>Neither party shall be liable for delays or failure to perform due to circumstances beyond their reasonable control, including but not limited to natural disasters, government actions, pandemics, or disruptions in technology infrastructure.</p>
            </div>
            <div>
              <h2 className="font-display text-xl font-bold text-cream mb-4">9. Governing Law & Jurisdiction</h2>
              <p>These Terms of Service are governed by and construed in accordance with the laws of Belgium. Any disputes arising from these terms or related services shall be submitted to the exclusive jurisdiction of the courts of Leuven, Belgium.</p>
            </div>
            <div>
              ...
              <div className="mt-4 border border-gold/10 p-6 bg-navy/30">
                ...
                <p className="mt-2">
                  <a href="mailto:contact@impera-group.com" className="text-gold hover:text-gold-light transition-colors">contact@impera-group.com</a>
                </p>
              </div>
            </div>
          </div>
